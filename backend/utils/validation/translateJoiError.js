const messages = Object.freeze({
  ar: Object.freeze({
    ...
    "string.arabicText": "يرجى إدخال الحقل {{field}} باللغة العربية",
    "string.englishText": "يرجى إدخال الحقل {{field}} باللغة الإنجليزية",
  ...
  en: Object.freeze({
    ...
    "string.arabicText": "{{field}} must be entered in Arabic",
    "string.englishText": "{{field}} must be entered in English",
