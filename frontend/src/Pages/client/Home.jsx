    ...
    <div className="min-h-screen bg-slate-50 px-4 py-10">
      <div className="mx-auto max-w-6xl text-center">
        ...
        <p className="mt-4 text-slate-600">
          اختر طريقة الحجز المناسبة لك، من البرامج الجاهزة أو تصميم برنامج
          مخصص أو حجز خدمة بشكل منفصل.
        </p>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              اختر من البرامج التي تم إعدادها مسبقًا بواسطة الإدارة، مع خدمات
              وفنادق ونقل محددة.
            </p>
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              صمّم برنامجك بنفسك باختيار الفنادق، النقل، التأشيرات، الرحلات
              والخدمات الإضافية.
            </p>
          ...
          <button
            ...
            className="rounded-2xl bg-white p-8 text-start shadow-sm border border-slate-100 hover:border-violet-400 hover:shadow-md transition"
          >
            <div className="text-4xl mb-4">🧳</div>
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              احجز خدمة مستقلة مثل الرحلات الجوية، السكن، النقل، التأشيرات،
              الزيارات أو الخدمات الإضافية.
            </p>

            <span className="mt-6 inline-block rounded-xl bg-violet-600 px-5 py-2 text-white font-bold">
              استعراض الخدمات
            </span>
          </button>
        </div>
