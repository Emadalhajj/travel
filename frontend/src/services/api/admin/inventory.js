...
export const apiGetInventory = (params) => api.get("/inventory", { params });

export const apiCreateInventory = (data) => api.post("/inventory", data);
...
export const apiDeleteInventory = (id) => api.delete(`/inventory/${id}`);
...
export const apiGetProgramInventory = ({ programId, startDate, endDate }) =>
  api.get("/inventory", {
    params: {
